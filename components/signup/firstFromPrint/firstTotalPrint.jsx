    ...
    if (signupInfo?.placeholder === "아이디") {
            ...
            <div key={index} className='flex flex-col justify-center'>
                ...
                {!isChecked && (
                    <div className="flex justify-center text-red-500">
                        <p>아이디가 존재하거나 유효하지 않습니다.<br/> 다시 입력해주세요</p>
                    </div>
                )}
            </div>
        )
            ...
            <div key={index} className='flex flex-col justify-center'>
                ...
                {passwordError && (
                    <div className="flex justify-center text-red-500 mt-2">
                        <p>비밀번호는 영대소문자 1자 이상, <br/>숫자 및 특수기호 1자 이상,<br/> 총 8자 이상</p>
                    </div>
                )}
            </div>
        )
        ...
        return (
            <div key={index} className='flex flex-col justify-center'>
                ...
                {emailError && (
                    <div className="flex justify-center text-red-500 mt-2">
                        <p>이메일이 유효하지 않습니다.<br/> 다시 입력해주세요</p>
                    </div>
                )}
            </div>
        )
        ...
        return (
            <div key={index} className='flex flex-col justify-center'>
                ...
                {nameError && (
                    <div className="flex justify-center text-red-500 mt-2">
                        <p>이름이 유효하지 않습니다. <br/> 다시 입력해주세요</p>
                    </div>
                )}
            </div>
        )
            ...
            <div key={index} className='flex flex-col justify-center'>
                ...
                {rePasswordError && (
                    <div className="flex ml-10 text-red-500 mt-2">
                        <p>비밀번호가 같지 않습니다. <br/>다시 입력해주세요</p>
                    </div>
                )}
            </div>
        )
