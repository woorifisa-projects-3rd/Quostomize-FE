        ...
        <div className="flex flex-col justify-center items-center mt-96">
            ...
            <FadeInSection>
                <div className="text-center text-4xl font-semibold">
                    <h1>
                        오직 나만을 위한 <span style={{ color: "#0083CA" }}>우리 금융 그룹<br /> '커스터 마이징'</span> 서비스 출시
                    </h1>
...
const FadeInText = ({ sentence }) => {
    ...
    return (
        ...
        >
            <span className="font-bold text-4xl relative" style={{ color: "#0083CA" }}>
                {firstChar}
            ...
            <span className="text-2xl font-semibold text-gray-700 ml-1">
                {restOfText}
            </span>
        </div>
    );
